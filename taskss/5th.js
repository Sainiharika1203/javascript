// Given an array of movie objects, each with properties movieName, movieHero, movieGenre, and releaseDate, write a function to sort the array in ascending order of the releaseDate
...
movie=movies.sort((a, b) => (a.releaseDate)==(b.releaseDate));
for(let a of movie)
    for(let key in a)
